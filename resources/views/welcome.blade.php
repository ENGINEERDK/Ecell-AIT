      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          @if (Auth::guard('entrepreneur')->check())
              <li><a href="{{ url('/entrepreneur/dashboard') }}">Your Dashboard</a></li>
  ...
  <section id="intro">
    <div class="intro-container wow fadeIn">
      ...
      <a href="{{route('events.index')}}">
           <p class="mb-4 pb-0"><span>Latest Event : </span> {{ $event->eventname}}</p>
      </a>
     
      <a href="{{ $event->eventvideo }}" class="venobox play-btn mb-4" data-vbtype="video"
        data-autoplay="true"></a>
      <a href="{{route('events.index')}}" class="about-btn">More About Event</a>
