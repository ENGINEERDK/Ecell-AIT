...
<div class="container contact-form">
    ...
    <form role="form" action="{{ route('Idea-Submission.store') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
       ...
       <div class="row">
        ...
        <div class="row text-center">
            <div class=" col-md-12 col-lg-12">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" required name="registration" value="1" {{ old('registration') ? 'checked' : '' }}> {{ __('Agrre with AIT E-cell T&C.') }}
                    </label>
                </div>
            </div>
        </div>
