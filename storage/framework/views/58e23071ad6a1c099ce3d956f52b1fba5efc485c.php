...
<div class="container contact-form">
    ...
    <form role="form" action="<?php echo e(route('Event-Registation.store')); ?>" method="POST" enctype="multipart/form-data">
       ...
       <div class="row">
        ...
        <div class="row text-center">
            <div class=" col-md-12 col-lg-12">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" required name="registration" value="1" <?php echo e(old('registration') ? 'checked' : ''); ?>> <?php echo e(__('Read about Event.')); ?>
